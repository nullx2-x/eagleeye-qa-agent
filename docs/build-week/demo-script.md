...
- [x] Replay ran against the local WordPress target and produced `PASS`, `1,745 ms`, screenshot/WebM evidence, and hashes.
...
- Demo target URL: `http://127.0.0.1:8888/` (local WordPress proof target)
